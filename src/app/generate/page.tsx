...
import { Camera, Sparkles, RotateCcw, Share2, ChevronRight, Lightbulb, ArrowRight, BookOpen, HelpCircle, Layers, X, CheckCircle, RefreshCw, Wand2 } from 'lucide-react';
...
const EXAMPLE_SUBJECTS = [
  ...
  { label: 'an elevator button', emoji: '🏢' },
  { label: 'a barcode', emoji: '📊' },
  { label: 'the sky', emoji: '🌤️' },
...
export default function GeneratePage() {
  ...
  const { state, showDiscoveryToast, showAchievementToast, addDiscovery, useCamera } = useGamification();
  ...
  return (
    <div className="min-h-screen bg-[#FAFAFA] text-gray-900 flex flex-col relative overflow-hidden">
      ...
      <header className="relative w-full px-5 py-4 flex items-center justify-between z-10">
        ...
        >
          {state.discoveries > 0 && (
            <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-white/80 backdrop-blur-sm border border-gray-100 shadow-sm">
              <div className="w-5 h-5 rounded-full bg-gradient-to-br from-[#FF6B35] to-[#FFD700] flex items-center justify-center">
                <span className="text-[9px] font-bold text-white">{state.discoveries}</span>
              </div>
              <span className="text-gray-500 text-xs font-medium">explored</span>
            </div>
          )}
        </motion.div>
      </header>
        ...
        {showAchievementToast && (
          ...
          >
            <div className="px-5 py-2.5 rounded-full bg-gray-900 text-white text-xs font-bold shadow-xl flex items-center gap-2">
              <span>🎉</span>
              <span>{showAchievementToast}</span>
            </div>
          </motion.div>
        )}
      </AnimatePresence>
            ...
            <section className="w-full pt-12 pb-8 px-5">
              ...
              >
                ...
                <p className="text-gray-500 text-base leading-relaxed max-w-xs mx-auto">
                  Point your camera at anything and get an instant explanation, lesson, or quiz.
                </p>
              </motion.div>
            </section>
              ...
              >
                ...
                >
                  ...
                  <div className="relative">
                    ...
                    <p className="text-white font-bold text-xl mb-1">Point & Learn</p>
                    <p className="text-white/70 text-sm">Tap to open camera</p>
                  </div>
                </motion.button>
                ...
                <motion.div 
                  ...
                  className="mt-6"
                >
                  <p className="text-[11px] text-gray-400 font-medium uppercase tracking-widest text-center mb-3">Or try these</p>
      ...
      <AnimatePresence mode="wait">
        {view === 'mode' && (
          <motion.div
            ...
            animate={{ opacity: 1, y: 0 }}
            exit={{ opacity: 0, y: -30 }}
            className="relative flex-1 flex flex-col z-10 px-5 pt-6"
          >
            <button 
              onClick={handleTryAnother}
              className="flex items-center gap-1.5 text-gray-400 text-xs hover:text-gray-600 transition-colors mb-4 self-start"
            >
              <X className="w-4 h-4" />
              Start over
            </button>
            ...
            <div className="space-y-3 pb-6">
              ...
              <motion.button
                ...
                className="w-full p-5 rounded-2xl bg-white border-2 border-[#FF6B35]/20 shadow-sm hover:shadow-md hover:border-[#FF6B35]/40 transition-all"
              >
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex-1 text-left">
                    <p className="font-bold text-gray-900 text-lg mb-0.5">Explain it</p>
              ...
              <motion.button
                ...
                className="w-full p-5 rounded-2xl bg-white border-2 border-[#FFD700]/20 shadow-sm hover:shadow-md hover:border-[#FFD700]/40 transition-all"
              >
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex-1 text-left">
                    <p className="font-bold text-gray-900 text-lg mb-0.5">Teach me</p>
              ...
              <motion.button
                ...
                className="w-full p-5 rounded-2xl bg-white border-2 border-[#00C896]/20 shadow-sm hover:shadow-md hover:border-[#00C896]/40 transition-all"
              >
                <div className="flex items-center gap-4">
              ...
              <motion.button
                ...
                whileHover={{ scale: 1.02, x: 4 }}
                whileTap={{ scale: 0.98 }}
                onClick={() => selectMode('deeper')}
                className="w-full p-5 rounded-2xl bg-gray-900 shadow-lg hover:shadow-xl transition-all"
              >
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex-1 text-left">
                    <p className="font-bold text-white text-lg mb-0.5">Go deeper</p>
      ...
      <AnimatePresence>
        {loading && view !== 'home' && view !== 'mode' && (
          <motion.div
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="flex-1 flex flex-col items-center justify-center px-5 z-10"
          >
            <motion.div
              initial={{ scale: 0.8 }}
              animate={{ scale: 1 }}
      ...
      <AnimatePresence mode="wait">
        {!loading && view === 'quiz' && (
          <motion.div
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="relative flex-1 flex flex-col z-10 px-5 py-6"
          >
            <div className="max-w-sm mx-auto w-full">
              ...
              <motion.button
                ...
                transition={{ delay: 0.5 }}
                onClick={loadLesson}
                className="w-full py-4 rounded-2xl bg-gradient-to-r from-[#FF6B35] to-[#FFD700] text-white font-bold text-base flex items-center justify-center gap-2 shadow-lg hover:shadow-xl transition-shadow"
              >
          ...
          >
            ...
            <div className="w-full px-5 pt-5 pb-4 bg-white border-b border-gray-100">
              <div className="max-w-sm mx-auto">
                <button 
                  onClick={handleTryAnother} 
                  className="flex items-center gap-1.5 text-gray-400 text-xs hover:text-gray-600 transition-colors mb-3"
                >
              ...
              <div className="max-w-sm mx-auto px-5 py-5 space-y-3">
                ...
                {result.hook && (
                  <motion.div
                    initial={{ opacity: 0, y: 10 }}
                    animate={{ opacity: 1, y: 0 }}
                    className="p-5 rounded-2xl bg-gradient-to-r from-[#FF6B35]/8 to-[#FFD700]/5 border border-[#FF6B35]/15"
                  >
                    <p className="text-base text-gray-800 font-medium leading-relaxed">"{result.hook}"</p>
                  </motion.div>
                )}
                ...
                {result.tryThis && (
                  <motion.div
                    ...
                    animate={{ opacity: 1, y: 0 }}
                    transition={{ delay: 0.25 }}
                    className="p-5 rounded-2xl bg-[#00C896]/8 border border-[#00C896]/20"
                  >
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    {(['explain', 'teach', 'quiz', 'deeper'] as Mode[]).filter(m => m !== mode).map(m => (
                      <button
                        ...
                        className="py-3 px-3 rounded-2xl bg-white border border-gray-200 text-gray-600 text-xs font-medium hover:border-[#FF6B35]/40 hover:text-[#FF6B35] hover:shadow-md transition-all"
                      >
